CREATE TABLE [SellerRating].[SellableInventoryRating] (
    ...
    CONSTRAINT [PK_SellerRating_SellableInventoryRating_SellableInventoryRatingHashKey] PRIMARY KEY CLUSTERED ([SellableInventoryRatingHashKey] ASC),
