CREATE TABLE [InventoryGuideAudit].[SellingTitle] (
    ...
    CONSTRAINT [PK_InventoryGuideAudit_SellingTitle_SellingTitleHashKey] PRIMARY KEY CLUSTERED ([SellingTitleHashKey] ASC)
);
