CREATE TABLE [InventoryGuideAudit].[RateCardDaypart] (
    ...
    CONSTRAINT [PK_InventoryGuideAudit_RateCardDaypart_RateCardDaypartHashKey] PRIMARY KEY CLUSTERED ([RateCardDaypartHashKey] ASC)
);
