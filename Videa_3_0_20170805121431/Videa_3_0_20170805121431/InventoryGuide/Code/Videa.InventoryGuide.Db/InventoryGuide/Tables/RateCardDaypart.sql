CREATE TABLE [InventoryGuide].[RateCardDaypart] (
    ...
    CONSTRAINT [PK_InventoryGuide_RateCardDaypart_RateCardDaypartHashKey] PRIMARY KEY CLUSTERED ([RateCardDaypartHashKey] ASC)
);
