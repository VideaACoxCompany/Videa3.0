...
MERGE INTO [InventoryGuide].[SellableInventory] WITH (HOLDLOCK)
 AS T
USING (SELECT @SellableInventoryHashKey AS SellableInventoryHashKey,
              ...
              @RatePeriodHashKey AS RatePeriodHashKey) AS NEW_T ON T.SellableInventoryHashKey = NEW_T.SellableInventoryHashKey
