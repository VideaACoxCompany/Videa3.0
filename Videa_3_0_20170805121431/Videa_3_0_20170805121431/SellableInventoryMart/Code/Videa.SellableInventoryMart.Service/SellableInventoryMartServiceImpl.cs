...
{
	public class SellableInventoryMartServiceImpl : SellableInventoryMartService.SellableInventoryMartServiceBase
	{
		#region Fields
		...
		public  override async Task<SellableInventoryPeriodDeleteResponse> SellableInventoryPeriodDelete(SellableInventoryPeriodDeleteRequest request, ServerCallContext context)
		{
			var res = await _executor.ExecuteAsync(new SellableInventoryPeriodDeleteQuery
			{
				SellableInventoryPeriodHashKey = request.SellableInventoryPeriodHashKey
			}).ConfigureAwait(false);
			
			var returnVal = res;
			
			var result = new SellableInventoryPeriodDeleteResponse
			{ 
			};
