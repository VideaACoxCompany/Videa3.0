CREATE TABLE [SIM].[SellableInventoryPeriod] (
    ...
    CONSTRAINT [PK_SIM_SellableInventoryPeriod_SellableInventoryPeriodHashKey] PRIMARY KEY CLUSTERED ([SellableInventoryPeriodHashKey] ASC)
);
