CREATE TABLE [SellerRateAudit].[SellableInventoryRate] (
    ...
    CONSTRAINT [PK_SellerRateAudit_SellableInventoryRate_SellableInventoryRateHashKey] PRIMARY KEY CLUSTERED ([SellableInventoryRateHashKey] ASC),
