CREATE TABLE [TrafficStatisticAudit].[RatePeriod] (
    ...
    CONSTRAINT [PK_TrafficStatisticAudit_RatePeriod_RatePeriodHashKey] PRIMARY KEY CLUSTERED ([RatePeriodHashKey] ASC)
);
