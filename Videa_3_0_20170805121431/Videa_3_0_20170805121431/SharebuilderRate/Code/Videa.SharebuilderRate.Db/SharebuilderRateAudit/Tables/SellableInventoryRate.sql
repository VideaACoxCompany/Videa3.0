CREATE TABLE [SharebuilderRateAudit].[SellableInventoryRate] (
    ...
    CONSTRAINT [PK_SharebuilderRateAudit_SellableInventoryRate_SellableInventoryRateHashKey] PRIMARY KEY CLUSTERED ([SellableInventoryRateHashKey] ASC),
