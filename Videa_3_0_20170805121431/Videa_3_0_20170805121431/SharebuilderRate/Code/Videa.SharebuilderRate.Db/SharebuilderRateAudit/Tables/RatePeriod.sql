CREATE TABLE [SharebuilderRateAudit].[RatePeriod] (
    ...
    CONSTRAINT [PK_SharebuilderRateAudit_RatePeriod_RatePeriodHashKey] PRIMARY KEY CLUSTERED ([RatePeriodHashKey] ASC)
);
