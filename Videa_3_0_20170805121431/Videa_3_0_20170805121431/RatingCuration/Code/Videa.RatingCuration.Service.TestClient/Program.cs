...
namespace Videa.RatingCurationNS.Service.TestClient
{
	public class Program
	{
		...
		public  static void Main(string [] args)
		{
			...
			var client = new RatingCurationService.RatingCurationServiceClient(channel);
			TestCurateSellerRatings(client);
