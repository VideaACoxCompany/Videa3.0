CREATE TABLE [AMAudit].[AvailLineWithDetailedPeriods] (
    ...
    CONSTRAINT [PK_AMAudit_AvailLineWithDetailedPeriods_AvailLineWithDetailedPeriodsHashKey] PRIMARY KEY CLUSTERED ([AvailLineWithDetailedPeriodsHashKey] ASC),
